...
const USAGE = [
  ...
  "",
  "Use `/direction/discover?q=...` before planning when important choices are still open.",
  "Scan its candidates, inspect at most 3, apply what fits, then compare the result.",
  "Use this exact route once the need is concrete.",
  "",
