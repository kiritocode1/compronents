...
const moneybeeAlpinePageAssets = [
  "Satoshi-Light.otf",
  "Satoshi-Medium.otf",
  "Satoshi-Regular.otf",
  "about-poster.jpg",
  ...
  "tab-ownership.jpg",
  "tab-research.jpg",
  "testimonial-video-poster.avif",
  "testimonial.mp4",
].map(
  (filename) =>
    ({
      id: `moneybee-alpine-page-${filename
        .replace(/[^a-z0-9]+/gi, "-")
        .replace(/^-|-$/g, "")
        .toLowerCase()}`,
      label: `Moneybee Alpine Page ${filename}`,
      provider: "vercel-blob",
      pathname: `moneybee-alpine-page/${filename}`,
      fallbackPath: `${BLOB_PUBLIC_ORIGIN}/moneybee-alpine-page/${filename}`,
      role: "Source media used by the Moneybee Alpine Page template.",
      notes: "Served from Vercel Blob at the stable registry pathname.",
    }) as const satisfies AssetItem,
);

const moneybeeEditorialPageAssets = [
  "about-image-01.avif",
  "about-image-02.avif",
  "arrow-plan.svg",
  "arrow-project.svg",
  ...
  "profile-3.avif",
  "profile-4.avif",
  "project-image-1.avif",
  "project-image-2.avif",
  "project-image-3.avif",
  "project-image-4.avif",
  "project-image-5.avif",
  "project-image-6.avif",
  "project-image-7.avif",
  "project-image-8.avif",
  "project-image-9.avif",
  "seo-2.svg",
  "seo.svg",
  "tick-circle.svg",
  "webclip.svg",
  ...
  (filename) =>
    ({
      id: `moneybee-editorial-page-${filename
        .replace(/[^a-z0-9]+/gi, "-")
        .replace(/^-|-$/g, "")
        .toLowerCase()}`,
      label: `Moneybee Editorial Page ${filename}`,
      provider: "vercel-blob",
      pathname: `moneybee-editorial-page/${filename}`,
      fallbackPath: `${BLOB_PUBLIC_ORIGIN}/moneybee-editorial-page/${filename}`,
      role: "Source media used by the Moneybee Editorial Page template.",
      notes: "Served from Vercel Blob at the stable registry pathname.",
    }) as const satisfies AssetItem,
);
...
export const assetItems = [
  ...
  {
    id: "lego-dither-hand",
    label: "Lego Dither hand model",
    provider: "vercel-blob",
    pathname: "lego-dither/marble-hand-2.glb",
    fallbackPath: `${BLOB_PUBLIC_ORIGIN}/lego-dither/marble-hand-2.glb`,
    role: "Spinning marble hand sampled by the Lego glyph dither pass.",
    notes: "Served from Vercel Blob at the stable registry pathname.",
  } as const satisfies AssetItem,
  {
    id: "lego-dither-sprite",
    label: "Lego Dither glyph sheet",
    provider: "vercel-blob",
    pathname: "lego-dither/lego-sprite.png",
    fallbackPath: `${BLOB_PUBLIC_ORIGIN}/lego-dither/lego-sprite.png`,
